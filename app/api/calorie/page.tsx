...
export default function CaloriePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white p-4 md:p-8">
      ...
      <label className="block bg-slate-900 border-2 border-dashed border-slate-700 rounded-xl p-8 text-center cursor-pointer hover:border-red-500 mb-4">
      ...
      {img && (
        <img
          src={img}
          alt="food"
          className="rounded-xl max-h-72 w-full object-cover mb-4"
        />
      )}
      ...
      {img && (
        <button
          onClick={analyze}
          disabled={loading}
          className="w-full py-3 rounded bg-red-600 hover:bg-red-500 font-semibold mb-6 disabled:opacity-50"
        >
      ...
      {result && (
        <div className="bg-slate-900 rounded-xl p-6 grid gap-4">
