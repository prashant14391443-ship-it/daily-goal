...
import { ScrollText, Sparkles, Save, Download, Copy, Pencil, Trash2, Dumbbell, Utensils, Moon, Lightbulb, Trophy } from "lucide-react";

type Ex = { day: string; name: string; sets: number; reps: string; rest: string };
type Blueprint = {
  title: string; split: { day: string; focus: string }[]; exercises: Ex[];
  topExercises?: string[]; progression: string;
  nutrition: { calories: number; protein: number; carbs: number; fat: number; foods: string[]; tip: string };
  recovery: { sleep: string; water: string; deload: string }; tips: string[];
};

const POOL: Record<string, { h: string; g: string; sets: number; reps: string; rest: string }[]> = {
  chest: [{h:"Push-ups",g:"Bench Press",sets:4,reps:"8-12",rest:"90s"},{h:"Incline push-ups",g:"Incline DB Press",sets:3,reps:"8-12",rest:"90s"},{h:"Diamond push-ups",g:"Cable Fly",sets:3,reps:"10-15",rest:"60s"},{h:"Pike push-ups",g:"Dips",sets:3,reps:"8-12",rest:"90s"}],
  back: [{h:"Pull-ups",g:"Barbell Row",sets:4,reps:"6-10",rest:"90s"},{h:"Chin-ups",g:"Lat Pulldown",sets:3,reps:"8-12",rest:"90s"},{h:"Superman hold",g:"Deadlift",sets:3,reps:"6-8",rest:"2min"},{h:"Inverted rows",g:"Seated Row",sets:3,reps:"10-12",rest:"75s"}],
  shoulders: [{h:"Pike push-ups",g:"Overhead Press",sets:4,reps:"8-12",rest:"90s"},{h:"Lateral raises (bottles)",g:"Lateral Raises",sets:3,reps:"12-15",rest:"60s"},{h:"Handstand hold",g:"Face Pulls",sets:3,reps:"30s",rest:"60s"},{h:"Wall slides",g:"Rear-delt Fly",sets:3,reps:"12-15",rest:"60s"}],
  biceps: [{h:"Chin-ups",g:"Barbell Curls",sets:3,reps:"8-12",rest:"75s"},{h:"Hammer curls (bottles)",g:"Hammer Curls",sets:3,reps:"10-12",rest:"60s"},{h:"Towel curls",g:"Incline Curls",sets:3,reps:"10-12",rest:"60s"},{h:"Chin-up hold",g:"Preacher Curls",sets:2,reps:"20s",rest:"60s"}],
  triceps: [{h:"Diamond push-ups",g:"Skull Crushers",sets:3,reps:"8-12",rest:"75s"},{h:"Bench dips",g:"Rope Pushdown",sets:3,reps:"10-15",rest:"60s"},{h:"Close-grip push-ups",g:"Close-grip Bench",sets:3,reps:"8-12",rest:"90s"},{h:"Overhead extension (bottle)",g:"Overhead Extension",sets:3,reps:"10-12",rest:"60s"}],
  forearms: [{h:"Dead hang",g:"Dead Hang",sets:3,reps:"30s",rest:"60s"},{h:"Farmer carry (bottles)",g:"Farmer Carry",sets:3,reps:"40m",rest:"60s"},{h:"Wrist curls (bottles)",g:"Wrist Curls",sets:3,reps:"15-20",rest:"45s"},{h:"Towel hang",g:"Reverse Curls",sets:2,reps:"20s",rest:"60s"}],
  legs: [{h:"Weighted squats",g:"Back Squat",sets:4,reps:"8-12",rest:"2min"},{h:"Lunges",g:"Romanian Deadlift",sets:3,reps:"10/leg",rest:"90s"},{h:"Step-ups",g:"Leg Press",sets:3,reps:"10",rest:"90s"},{h:"Calf raises",g:"Calf Raises",sets:4,reps:"15-20",rest:"45s"}],
  abs: [{h:"Hanging leg raises",g:"Hanging Leg Raises",sets:3,reps:"10-15",rest:"60s"},{h:"Plank",g:"Ab-wheel",sets:3,reps:"45s",rest:"45s"},{h:"Bicycle crunch",g:"Cable Crunch",sets:3,reps:"15-20",rest:"45s"},{h:"Leg raises",g:"Hanging Knee Raises",sets:3,reps:"12-15",rest:"45s"}],
  arms: [{h:"Chin-ups",g:"Barbell Curls",sets:3,reps:"8-12",rest:"75s"},{h:"Bench dips",g:"Skull Crushers",sets:3,reps:"10-12",rest:"75s"},{h:"Hammer curls (bottles)",g:"Hammer Curls",sets:3,reps:"10-12",rest:"60s"},{h:"Diamond push-ups",g:"Rope Pushdown",sets:3,reps:"8-12",rest:"60s"}],
  upper: [{h:"Push-ups",g:"Bench Press",sets:4,reps:"8-12",rest:"90s"},{h:"Pull-ups",g:"Barbell Row",sets:4,reps:"6-10",rest:"90s"},{h:"Pike push-ups",g:"Overhead Press",sets:3,reps:"8-12",rest:"90s"},{h:"Chin-ups",g:"Barbell Curls",sets:3,reps:"8-12",rest:"75s"},{h:"Bench dips",g:"Skull Crushers",sets:3,reps:"10-12",rest:"60s"}],
  push: [{h:"Push-ups",g:"Bench Press",sets:4,reps:"8-12",rest:"90s"},{h:"Pike push-ups",g:"Overhead Press",sets:3,reps:"8-12",rest:"90s"},{h:"Incline push-ups",g:"Incline DB Press",sets:3,reps:"8-12",rest:"90s"},{h:"Diamond push-ups",g:"Cable Fly",sets:3,reps:"10-15",rest:"60s"},{h:"Lateral raises (bottles)",g:"Lateral Raises",sets:3,reps:"12-15",rest:"60s"}],
  pull: [{h:"Pull-ups",g:"Barbell Row",sets:4,reps:"6-10",rest:"90s"},{h:"Chin-ups",g:"Lat Pulldown",sets:3,reps:"8-12",rest:"90s"},{h:"Superman hold",g:"Deadlift",sets:3,reps:"6-8",rest:"2min"},{h:"Hammer curls (bottles)",g:"Hammer Curls",sets:3,reps:"10-12",rest:"60s"},{h:"Inverted rows",g:"Seated Row",sets:3,reps:"10-12",rest:"75s"}],
  full: [{h:"Push-ups",g:"Bench Press",sets:3,reps:"8-12",rest:"90s"},{h:"Pull-ups",g:"Barbell Row",sets:3,reps:"6-10",rest:"90s"},{h:"Weighted squats",g:"Back Squat",sets:3,reps:"8-12",rest:"2min"},{h:"Plank",g:"Ab-wheel",sets:3,reps:"45s",rest:"45s"},{h:"Pike push-ups",g:"Overhead Press",sets:3,reps:"8-12",rest:"90s"}],
  run: [{h:"Brisk run intervals",g:"Treadmill intervals",sets:1,reps:"20min",rest:"-"},{h:"Tempo run",g:"Tempo run",sets:1,reps:"15min",rest:"-"},{h:"Hill sprints",g:"Incline sprints",sets:6,reps:"20s",rest:"60s"},{h:"Strides",g:"Strides",sets:4,reps:"60m",rest:"45s"}],
};
...
export default function BlueprintPage() {
  ...
  const fatTarget = Math.round((cal * 0.25) / 9);
  const carbTarget = Math.max(Math.round((cal - proteinTarget * 4 - fatTarget * 9) / 4), 0);
  ...
  const makeDayExercises = (day: string, focus: string): Ex[] => {
    ...
    return Array.from({ length: Number(perSession) }, (_, k) => { const e = pool[k % pool.length]; return { day, name: home ? e.h : e.g, sets: e.sets, reps: e.reps, rest: e.rest }; });
  };
  const buildOffline = (): Blueprint => {
    ...
    return {
      ...
      nutrition: { calories: cal, protein: proteinTarget, carbs: carbTarget, fat: fatTarget, foods: diet !== "Non-vegetarian" ? VEG_FOODS : NONVEG_FOODS, tip: `Protein = ${autoWeight || 70}kg × ${proteinFactor} = ${proteinTarget}g. Drink 3-4 L water.` },
      recovery: { sleep: "7-9 hours", water: "3-4 litres", deload: "Every 4-6 weeks, halve volume" },
      tips: ["Progressive overload every week","Protein with every meal","Slow eccentric (2-3s down)","Warm up before lifting","Watch tutorials or record yourself to check form"],
    };
  };

  const generate = async () => {
    setBusy(true); setError(""); setBp(null); setEdit(false);
    if (!useAI) { setBp(buildOffline()); notify("📘 Built-in plan"); setBusy(false); return; }
    try {
      const res = await fetch("/api/blueprint", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ goal, days, level, equipment, perSession, calories: cal, direction, diet, weight: autoWeight, pf: proteinFactor, splitStyle, protein: proteinTarget, carbs: carbTarget, fat: fatTarget }) });
  ...
  const setFocus = (i: number, focus: string) => setBp((b) => { if (!b) return b; const day = b.split[i].day; return { ...b, split: b.split.map((s, j) => (j === i ? { ...s, focus } : s)), exercises: [...b.exercises.filter((e) => e.day !== day), ...makeDayExercises(day, focus)] }; });
  ...
  const download = () => {
    ...
    t += `\nWORKOUTS\n`;
    bp.split.forEach((s) => { t += `\n[${s.day} • ${s.focus}]\n`; bp.exercises.filter((e) => e.day === s.day).forEach((e) => { t += `  ${e.name} — ${e.sets} sets × ${e.reps}, rest ${e.rest}\n`; }); });
    t += `\nPROGRESSION\n${bp.progression}\n\nNUTRITION — ${bp.nutrition.calories} kcal | P${bp.nutrition.protein} C${bp.nutrition.carbs} F${bp.nutrition.fat}\n${bp.nutrition.foods.map((f)=>`• ${f}`).join("\n")}\n${bp.nutrition.tip}\n\nRECOVERY\nSleep: ${bp.recovery.sleep}\nWater: ${bp.recovery.water}\nDeload: ${bp.recovery.deload}\n\nTIPS\n${bp.tips.map((x)=>`• ${x}`).join("\n")}\n`;
    ...
    <main className="min-h-screen bg-slate-950 text-white px-4 pt-6 pb-24 max-w-4xl mx-auto">
      <div className="relative mb-5 overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-500 via-violet-600 to-purple-600 p-5 shadow-xl shadow-violet-900/20">
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] text-white/75 font-semibold mt-0.5">AI personalized plan — exercises, macros, tips</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 mb-5 grid gap-3 grid-cols-2">
        ...
        <button onClick={generate} disabled={busy} className="press col-span-2 py-3 rounded-xl bg-indigo-500/15 border border-indigo-500/30 text-sm font-black text-indigo-300 disabled:opacity-50 flex items-center justify-center gap-1.5">
          <Sparkles size={15} /> {busy ? "Researching…" : "Build Blueprint"}
        </button>
      </div>
      {autoCal && <p className="text-[10px] text-slate-500 font-bold -mt-3 mb-4">🎯 Macros: {cal} kcal • P{proteinTarget} C{carbTarget} F{fatTarget} ({direction})</p>}
        ...
        <div className="grid gap-4">
          ...
          {(bp.topExercises || []).length > 0 && (
            <div className="bg-slate-900 border border-amber-500/30 rounded-2xl p-4">
              <p className="text-xs font-black text-amber-400 mb-2 flex items-center gap-1.5"><Trophy size={14} /> TOP EXERCISES FOR THIS GOAL</p>
                ...
                {bp.exercises.filter((e) => e.day === s.day).map((e, ei) => {
                  ...
                  return (
                    <div key={ei} className="bg-slate-800/60 rounded-xl p-3">
                      ...
                      ) : (<p className="text-xs text-indigo-300 font-black">{e.sets} sets × {e.reps} • rest {e.rest}</p>)}
                    </div>
                  );
                })}
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4">
            <p className="text-xs font-black text-slate-400 mb-2 flex items-center gap-1.5"><Utensils size={14} /> NUTRITION — {bp.nutrition.calories} kcal</p>
            <div className="grid grid-cols-3 gap-2 mb-2">
              {edit ? (
                <>
                  ...
                  <input type="number" value={bp.nutrition.carbs} onChange={(e) => setNut({ carbs: Number(e.target.value) })} className="p-2 rounded-lg bg-slate-800 border border-slate-700 text-sm" />
                  <input type="number" value={bp.nutrition.fat} onChange={(e) => setNut({ fat: Number(e.target.value) })} className="p-2 rounded-lg bg-slate-800 border border-slate-700 text-sm" />
                </>
              ) : (
                <>
                  ...
                  <div className="bg-slate-800/60 rounded-xl p-3"><p className="text-[10px] text-slate-500 font-black">CARBS</p><p className="font-black text-blue-400">{bp.nutrition.carbs}g</p></div>
                  <div className="bg-slate-800/60 rounded-xl p-3"><p className="text-[10px] text-slate-500 font-black">FAT</p><p className="font-black text-yellow-400">{bp.nutrition.fat}g</p></div>
                </>
              )}
            </div>
            <p className="text-[10px] font-black text-slate-500 mb-1">BEST FOODS — P/C/F per 100g</p>
