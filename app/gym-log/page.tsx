  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white px-4 pt-6 pb-24 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-black bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">Gym</h1>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link
          href="/workout"
          className="press bg-slate-900 border border-green-500/30 rounded-2xl p-4 text-center shadow-lg shadow-black/30"
        >
        ...
        <Link
          href="/calorie"
          className="press bg-slate-900 border border-amber-500/30 rounded-2xl p-4 text-center shadow-lg shadow-black/30"
        >
        ...
        <Link
          href="/calculator"
          className="press bg-slate-900 border border-rose-500/30 rounded-2xl p-4 text-center shadow-lg shadow-black/30"
        >
        ...
        <Link
          href="/move"
          className="press col-span-2 bg-slate-900 border-2 border-green-500/50 rounded-2xl p-4 text-center shadow-lg shadow-green-900/20"
        >
