...
import { ListChecks, Plus, Trash2, Flame, Anchor, PartyPopper, X, Landmark, Clock, MapPin, Pencil, Bell, BellOff, ChevronLeft, ChevronRight, Sparkles } from "lucide-react";
...
export default function HabitLogPage() {
  ...
  useEffect(() => {
    ...
    const check = () => {
      ...
      let fired: any = {};
      try { fired = JSON.parse(localStorage.getItem("dg-habit-rem-fired") || "{}"); } catch { fired = {}; }
          ...
          {habits.length > 0 && (
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 mb-4">
              <div className="flex justify-between text-xs font-black mb-2">
                <span className="text-slate-400">{viewDate === today ? "TODAY" : viewDate}</span>
