  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white px-4 pt-6 pb-24 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-black bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent">Habits</h1>
          <p className="text-[10px] text-slate-400 font-semibold">Small daily wins = big life</p>
        </div>
      </div>

      <div className="grid grid-cols-2 gap-3">
        <Link href="/habitslog" className="press bg-slate-900 border border-violet-500/30 rounded-2xl p-4 shadow-lg shadow-black/30">
        ...
        <Link href="/habit-stats" className="press bg-slate-900 border border-blue-500/30 rounded-2xl p-4 shadow-lg shadow-black/30">
        ...
        <Link href="/freeze" className="press bg-slate-900 border border-cyan-500/30 rounded-2xl p-4 shadow-lg shadow-black/30">
        ...
        <Link href="/routines" className="press bg-slate-900 border border-amber-500/30 rounded-2xl p-4 shadow-lg shadow-black/30">
