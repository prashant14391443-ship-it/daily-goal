...
export default function Signup() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-4 md:p-8">
      <form onSubmit={handleSignup} className="bg-slate-900 p-4 md:p-8 rounded-lg w-full max-w-md flex flex-col gap-4">
